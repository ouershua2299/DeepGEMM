...
static void sm90_nvfp4_h200_fused_mega_moe(
    ...
    // The all-M host policy owns the production selector.  Environment
    ...
    const SM90NVFP4H200FusedRuntime::Args args = {
        ...
        // RS consumes the same Mode2-braided packed ABI but requires the
        // register fragment mapping even in schedule bands whose SS arm uses
        // the older braided shared-LUT row decoder.
